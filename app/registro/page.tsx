...
export default async function RegisterPage() {
  ...
  return <main className="authShell registerShell">
    <section className="authIntro"><p className="eyebrow">Scanner Pliin</p><h1>Comece sua jornada acessível.</h1><p>Crie sua conta para registrar auditorias e acompanhar a evolução dos seus sites.</p></section>
