...
export default async function RegisterPage() {
  ...
  return <main className="authShell registerShell">
    ...
    <section className="authCard"><h2>Criar conta</h2><p>Seus documentos são protegidos e não são armazenados em texto puro.</p><AuthForm mode="register" /><p className="authSwitch">Já possui conta? <a href="/app/login">Entrar</a></p></section>
  </main>;
}
